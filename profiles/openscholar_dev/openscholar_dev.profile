...
function openscholar_dev_profile_tasks(&$task, $url) {
  ...
  if ($task == 'openscholar-configure') {
    ...
    // create roles
    _openscholar_dev_profiles_create_roles();

    // configure wisywig/tinymce
    _openscholar_dev_profiles_wysiwyg_config();
 ...
 *  TODO: permissions
 */
function _openscholar_dev_profiles_configure_biblio(){
...
function   _openscholar_dev_profiles_wysiwyg_config(){
  $settings = array (
    'default' => 1,
    'user_choose' => 0,
    'show_toggle' => 1,
