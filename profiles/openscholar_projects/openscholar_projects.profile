...
function openscholar_projects_profile_details() {
  return array(
    'name' => 'OpenScholar: Academic projects web sites',
    'description' => 'Choose this options for projects web sites'
  );
}
 ...
 */
function openscholar_projects_profile_task_list() {
  $tasks = array(
 ...
 */
function openscholar_projects_profile_tasks(&$task, $url) {
  ...
  if ($task == 'profile') {
    ...
    'finished' => '_openscholar_projects_profile_batch_finished',
  ...
  if ($task == 'scholar_projects-configure') {
    ...
    // enable the themes
    _openscholar_projects_enable_themes();
    ...
    _openscholar_projects_configure_biblio();
 ...
 */
function _openscholar_projects_profile_batch_finished($success, $results) {
 ...
 *  TODO: permissions
 */
function _openscholar_projects_configure_biblio(){
