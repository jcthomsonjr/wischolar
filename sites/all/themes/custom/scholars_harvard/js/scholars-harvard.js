...
$(document).ready(function() {
  ...
  var startheight = $('#startpage').height();
  $('#start-learnmore a').attr("href","#").click(function(event){
    	$('#startpage').animate({
  ...
  $('#reasons-home').attr("href","#").click(function(event){
    	$('#startpage').animate({
    	  marginTop:"0"
    	  });
    	$('#reasons').hide();
    ...
    $('#reasons_header h1 a').click(function(event){
    	$('#startpage').animate({
    	  marginTop:"0"
    	  });
    	$('#reasons').hide();
