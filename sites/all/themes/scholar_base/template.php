 ...
 *   scholar_base theme would define a scholar_base_breadcrumb() function.
 *
...
/*
if (theme_get_setting('scholar_base_fixed')) {
 ...
 */
/* -- Delete this line if you want to use this function
function scholar_base_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
