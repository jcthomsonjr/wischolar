            ...
            <div id="content-row-3">
              ...
              <div id="new-sites">
                <div class="new-site-block">
                  <div class="photo">
                    <img src="<?php print $base_url . $directory;?>/images/scholar-photo1.jpg" />
                   </div>
                 <h4>Susan J. Pharr</h4>
                ...
                <div class="new-site-block">
                  <div class="photo">
                    <img src="<?php print $base_url . $directory;?>/images/scholar-photo2.jpg" />
                   </div>
                 <h4>Susan J. Pharr</h4>
                 <h5>Edwin O. Reischauer Professor of Japanese Politics</h5>
                </div>
                <div class="new-site-block">
                  <div class="photo">
                    <img src="<?php print $base_url . $directory;?>/images/scholar-photo3.jpg" />
                   </div>
                 <h4>Susan J. Pharr</h4>
                 <h5>Edwin O. Reischauer Professor of Japanese Politics</h5>
                </div>
                <div class="new-site-block">
                  <div class="photo">
                    <img src="<?php print $base_url . $directory;?>/images/scholar-photo4.jpg" />
                   </div>
                 <h4>Susan J. Pharr</h4>
                 <h5>Edwin O. Reischauer Professor of Japanese Politics</h5>
                </div>
                <div class="new-site-block">
                  <div class="photo">
                    <img src="<?php print $base_url . $directory;?>/images/scholar-photo5.jpg" />
                   </div>
                 <h4>Susan J. Pharr</h4>
                 <h5>Edwin O. Reischauer Professor of Japanese Politics</h5>
                </div>
                <div class="new-site-block">
                  <div class="photo">
                    <img src="<?php print $base_url . $directory;?>/images/scholar-photo6.jpg" />
                   </div>
                 <h4>Susan J. Pharr</h4>
                 <h5>Edwin O. Reischauer Professor of Japanese Politics</h5>
                </div>
